...
var (
	...
	GetWithContext    = defaultClient.GetWithContext
	PostWithContext   = defaultClient.PostWithContext
	PutWithContext    = defaultClient.PutWithContext
	PatchWithContext  = defaultClient.PatchWithContext
	DeleteWithContext = defaultClient.DeleteWithContext
	Do                = defaultClient.Do
...
func (c *Client) Get(rawUrl string, params ...interface{}) *Response {
	return c.Do(nil, http.MethodGet, rawUrl, params...)
}

// Post is a shortcut for client.Do("Post", url, params).
func (c *Client) Post(rawUrl string, params ...interface{}) *Response {
	return c.Do(nil, http.MethodPost, rawUrl, params...)
}

// Put is a shortcut for client.Do("Put", url, params).
func (c *Client) Put(rawUrl string, params ...interface{}) *Response {
	return c.Do(nil, http.MethodPut, rawUrl, params...)
}

// Patch is a shortcut for client.Do("Patch", url, params).
func (c *Client) Patch(rawUrl string, params ...interface{}) *Response {
	return c.Do(nil, http.MethodPatch, rawUrl, params...)
}

// Delete is a shortcut for client.Do("Delete", url, params).
func (c *Client) Delete(rawUrl string, params ...interface{}) *Response {
	return c.Do(nil, http.MethodDelete, rawUrl, params...)
}

// Get is a shortcut for client.Do("Get", url, params).
func (c *Client) GetWithContext(ctx context.Context, rawUrl string, params ...interface{}) *Response {
	return c.Do(ctx, http.MethodGet, rawUrl, params...)
}

// Post is a shortcut for client.Do("Post", url, params).
func (c *Client) PostWithContext(ctx context.Context, rawUrl string, params ...interface{}) *Response {
	return c.Do(ctx, http.MethodPost, rawUrl, params...)
}

// Put is a shortcut for client.Do("Put", url, params).
func (c *Client) PutWithContext(ctx context.Context, rawUrl string, params ...interface{}) *Response {
	return c.Do(ctx, http.MethodPut, rawUrl, params...)
}

// Patch is a shortcut for client.Do("Patch", url, params).
func (c *Client) PatchWithContext(ctx context.Context, rawUrl string, params ...interface{}) *Response {
	return c.Do(ctx, http.MethodPatch, rawUrl, params...)
}

// Delete is a shortcut for client.Do("Delete", url, params).
func (c *Client) DeleteWithContext(ctx context.Context, rawUrl string, params ...interface{}) *Response {
